...
robin = User.create(name: 'Robin', username: 'rtram', password: '123', avatar: 'https://media.licdn.com/dms/image/C5103AQEwJ__cO1769g/profile-displayphoto-shrink_800_800/0?e=1559174400&v=beta&t=zddijNVtg7NQMuhye1NQq479pLulAHiBHRYrRveDbwg')
anna = User.create(name: 'Anna', username: 'conaway', password: '123', avatar: 'https://media.licdn.com/dms/image/C5603AQGF2d0pYtafYA/profile-displayphoto-shrink_800_800/0?e=1559174400&v=beta&t=8T5ifUUHyMgYhQUJdPgsOc0SM6I1-gdv2C3mPFvmqKI')
...
jenny = User.create(name: 'Jenny', username: 'jenny', password: '123', avatar: 'https://media.licdn.com/dms/image/C4E03AQHFD-9C2jJj0g/profile-displayphoto-shrink_800_800/0?e=1559174400&v=beta&t=_Ksd3fZtyzMTG0S2bZoxpuajlBiLp_jLkNicXyTWvtc')
...
marissa = User.create(name: 'Marissa', username: 'sotto', password: '123', avatar: 'https://media.licdn.com/dms/image/C4E03AQHBuDzLv-dQAQ/profile-displayphoto-shrink_800_800/0?e=1559174400&v=beta&t=OzC5sh9L4vIv5yoeNVL23bSi0bcfI_h1YczNpJKsLJs')
...
jason = User.create(name: 'Jason', username: 'json', password: '123', avatar: 'https://media.licdn.com/dms/image/C4E03AQE71zt4O3843g/profile-displayphoto-shrink_800_800/0?e=1559174400&v=beta&t=OCCzCrcN08sBzMVCNXUPpaCJshsD-3E1jEK9IQBmw9Q')
